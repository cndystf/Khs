      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-2 text-gray-800">
            <center>Edit Kartu Hasil Studi</center>
          </h1>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Edit Mata Kuliah dan Nilai</h6>
            </div>
            <div class="card-body">
              <form action="actupdate?id=<?= $_GET['id'] ?>" method="post">
                <?php
                //$matkul ada di controller Input
                foreach ($matkul as $row) { ?>
                  <table class="table table-bordered">
                    <tr>
                      <td>Mata Kuliah</td>
                      <td><input type="text" class="form-control" name='namamk' value="<?= $row->namamk ?>"></td>
                    </tr>
                    <tr>
                      <td>Nilai</td>
                      <td><input type="number" class="form-control" name="mk" value="<?= $row->nilai ?>"></td>
                    </tr>
                    <tr>
                      <td colspan="3">
